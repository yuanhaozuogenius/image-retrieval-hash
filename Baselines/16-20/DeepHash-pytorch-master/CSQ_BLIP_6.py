...
from loss.csqPlusLoss import CSQPlusLoss
...
def train_val(config, bit):
    ...
    for epoch in range(config["epoch"]):
        ...
        for images, labels, ind, paths in train_loader:
            ...
            total_loss = csq_plus_loss + align_weight * align_loss + text_anchor_weight * id_loss + contrast_weight * contrast_loss
            ...
            csq_plus_loss_meter += csq_plus_loss.item()
