...
def load_model_and_preprocess(name, model_type, is_eval=False, device="cpu"):
    ...
    # load model
    if name == "blip2" and model_type == "pretrain":
        from lavis.common.utils import download_cached_file
        url = "https://storage.googleapis.com/sfr-vision-language-research/BLIP2/models/model_base.pth"  # 官方 Pretrain 权重地址
        pretrain_path = download_cached_file(url, check_hash=False, progress=True)
        model = model_cls.from_pretrained(pretrain_path)
    else:
